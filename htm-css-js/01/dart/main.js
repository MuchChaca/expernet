...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    main: [function() {
      var t1, t2, t3;
      t1 = document;
      t2 = t1.querySelector("#playfield-h1");
      t3 = t2.style;
      t3.color = "cyan";
      t2 = t2.style;
      t2.fontSize = "100px";
      t2 = t1.querySelector("#numbs").style;
      t2.listStyleType = "upper-roman";
      t1 = J.get$onClick$x(t1.querySelector("#playfield-h1"));
      W._EventStreamSubscription$(t1._html$_target, t1._eventType, new F.main_closure(new F.main_changeColorD()), false, H.getTypeArgumentByIndex(t1, 0));
    }, "call$0", "main__main$closure", 0, 0, 1],
    main_changeColorD: {
      "^": "Closure:12;",
      call$1: function(color) {
        var t1, t2;
        t1 = document.querySelector("#playfield-h1");
        t2 = t1.style;
        t2.color = color;
        return t1;
      }
    ...
    main_closure: {
      "^": "Closure:2;changeColorD",
      call$1: function(e) {
        return this.changeColorD.call$1("gold");
      }
    }
  }, 1]];
  setupProgram(dart, 0);
...
;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, v: true}, {func: 1, args: [,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, v: true, args: [P.String]}];
